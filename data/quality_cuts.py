...
files  = []
files.extend(glob.glob(data_location + 'Level2_IC86_corsika_icetop.010959.000*'))
files.extend(glob.glob(data_location + 'Level2_IC86_corsika_icetop.010959.001*'))
files.extend(glob.glob(data_location + 'Level2_IC86_corsika_icetop.010959.002*'))
files.extend(glob.glob(data_location + 'Level2_IC86_corsika_icetop.010959.003*'))
files.extend(glob.glob(data_location + 'Level2_IC86_corsika_icetop.010959.004*'))
